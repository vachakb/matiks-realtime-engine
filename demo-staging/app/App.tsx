...
import { decryptOffThread, decryptOnJsThread, hasNativeModule } from './decrypt';
...
export default function App() {
  ...
  const [running, setRunning] = useState<null | 'A' | 'B'>(null);
    ...
    <View style={styles.root}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        >
          ...
          <Text style={styles.buttonSub}>MatiksRealtime.decryptQuestions · spinner KEEPS SPINNING</Text>
        </Pressable>

        {running && (
          <Text style={styles.runningNote}>
            Running {running === 'A' ? 'A (JS thread)…' : 'B (off-thread)…'} watch the spinner
          </Text>
        )}
